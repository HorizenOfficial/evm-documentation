...
In the **Explore** page, you can choose from a collection of popular deployed contracts, which includes NFTs, Token, and Marketplace. For this exercise, a pre-built token is deployed.
#### Deploy Token
