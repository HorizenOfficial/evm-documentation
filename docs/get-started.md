...
In order to interact with smart contracts in the EVM, you need a valid EVM-compatible wallet such as [MetaMask](https://metamask.io/). The wallet needs to connect to the EON network (Testnet).
...
1. Download the Metamask wallet extension into your browser (Chrome, iOS, or Android) by going to the [Metamask](https://metamask.io/download/) website.
