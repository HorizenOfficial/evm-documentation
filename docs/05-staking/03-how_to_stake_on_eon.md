...
# How to Stake on EON
A forger is required to run a node. See [How to Locally Build and Deploy](../horizen_eon/04-develop_and_deploy_smart_contracts/04-local_build_and_deploy.md) for information on creating and running a node.  
